...
- Obtain the token via your auth flow (e.g. login/register endpoints); see [Auth Context](/explanation/project-analysis#-context-providers) (project analysis) in the project analysis.
...
- [Project Analysis](/explanation/project-analysis) — modules and contexts.